...
export class RegisterComponent {
  ...
  sendRegister() {   
    console.log("** ", this.registerForm.value.email, this.registerForm.value.passwords.password);
    
    from(
      this.supaService.sendRegistrerInfo(this.registerForm.value.email, this.registerForm.value.passwords.password)
    ).subscribe({
